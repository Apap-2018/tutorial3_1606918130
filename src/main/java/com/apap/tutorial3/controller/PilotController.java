...
public class PilotController {
	...
	public String editFlyHour(
		...
		if (archive==null) {
			...
			model.addAttribute("success", archive.getName()+ " berhasil diubah");
			model.addAttribute("pilot", archive);
	...
	public String delete(
		...
		if (pilotRemove==null) {
			...
			model.addAttribute("success", pilotRemove.getName()+ " berhasil dihapus");
